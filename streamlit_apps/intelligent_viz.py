...
class DataProfiler:
    ...
    def profile_column(df: pd.DataFrame, col: str) -> ColumnProfile:
        """Create detailed profile of a single column"""
        series = df[col]
...
class IntelligentChartSelector:
    ...
    def select_charts(
        ...
        """
        Select appropriate chart types with configurations.
        Returns list of (ChartType, config_dict) tuples.
        """
        recommendations = []
...
class SmartAggregator:
    ...
    def aggregate_for_chart(
        ...
        """Apply smart aggregation based on chart type and data characteristics"""
...
class VisualizationEngine:
    ...
    def create_chart(
        ...
        """Create a Plotly chart based on type and configuration"""
